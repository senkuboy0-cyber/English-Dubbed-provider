...
open class Anichi : MainAPI() {
    ...
    companion object {
        // Hardcoded API endpoints (replace these with actual values if you have them)
        // Common Anichi/Allanime API endpoints - update if needed
        const val apiUrl = "https://allanime.day/api"
        const val apiEndPoint = "https://allanime.day"
